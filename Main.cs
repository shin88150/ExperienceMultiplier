...
namespace ExperienceMultiplier
{
    ...
    {
        public int GeneralMultiplier { get; set; } = 15;
        public int CombatMultiplier { get; set; } = 15;
        public int FarmingMultiplier { get; set; } = 15;
        public int FishingMultiplier { get; set; } = 15;
        public int MiningMultiplier { get; set; } = 15;
        public int ForagingMultiplier { get; set; } = 15;
        public int LuckMultiplier { get; set; } = 15;
    }
